...
const downloads = {
    'android': `https://github.com/ixian-platform/Spixi/releases/download/${spixiVersion}/Spixi-${spixiVersion}-Android.apk`,
    'windows': `https://github.com/ixian-platform/Spixi/releases/download/${spixiVersion}/Spixi-${spixiVersion}-Win.zip`
}
</script>
